...
import { setProfileImage, editUser } from '../actions';
...
const Uploadimage = (props) => {
    ...
    const handleBtnClick = () => { inputFileRef.current.click(); }
    const formHandler = (e) => {
        e.preventDefault();
    ...
    return (
        <div>
            <div className="imageCircle">
                ...
                <input type="button" className='imagenbutton' onClick={handleBtnClick} />
            </div>
